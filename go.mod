module github.com/go-zhouxun/ethclient
...
require (
	...
	github.com/go-zhouxun/xlog v0.0.0-20190425111112-92bd6a3bff95
	github.com/go-zhouxun/xutil v0.0.0-20190425112111-e64c53fe6144
)
